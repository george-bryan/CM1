...
env 
#mpiexec -n 8 -ppn 4 ./setdev.sh ./cm1.exe --namelist namelist.figureE.gpu >& gpu=8.figureE.512x512.log
mpiexec -n 8 -ppn 4 ./setdev.sh ./cpu.exe --namelist namelist.figureD.gpu >& gpu=8.figureD.256.log
